...
#include "object_detection_msgs/msg/detail/objects__rosidl_typesupport_fastrtps_c.h"
...
#include "object_detection_msgs/msg/detail/object__functions.h"  // objects
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_object_detection_msgs
...
using _Objects__ros_msg_type = object_detection_msgs__msg__Objects;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, object_detection_msgs, msg, Object
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      object_detection_msgs__msg__Object__Sequence__fini(&ros_message->objects);
    }
    if (!object_detection_msgs__msg__Object__Sequence__init(&ros_message->objects, size)) {
...
size_t get_serialized_size_object_detection_msgs__msg__Objects(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Objects__ros_msg_type * ros_message = static_cast<const _Objects__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_object_detection_msgs__msg__Object(
...
static uint32_t _Objects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_object_detection_msgs__msg__Objects(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_object_detection_msgs
size_t max_serialized_size_object_detection_msgs__msg__Objects(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_object_detection_msgs__msg__Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = object_detection_msgs__msg__Objects;
    is_plain =
      (
...
static size_t _Objects__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_object_detection_msgs__msg__Objects(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, object_detection_msgs, msg, Objects)() {
