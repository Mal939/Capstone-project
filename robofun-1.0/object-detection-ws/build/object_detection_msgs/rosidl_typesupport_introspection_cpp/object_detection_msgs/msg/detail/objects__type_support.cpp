...
{
  new (message_memory) object_detection_msgs::msg::Objects(_init);
}

void Objects_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_detection_msgs::msg::Objects *>(message_memory);
  typed_message->~Objects();
}

size_t size_function__Objects__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<object_detection_msgs::msg::Object> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<object_detection_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<object_detection_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const object_detection_msgs::msg::Object *>(
    get_const_function__Objects__objects(untyped_member, index));
  auto & value = *reinterpret_cast<object_detection_msgs::msg::Object *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<object_detection_msgs::msg::Object *>(
    get_function__Objects__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const object_detection_msgs::msg::Object *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Objects_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(object_detection_msgs::msg::Objects, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<object_detection_msgs::msg::Object>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(object_detection_msgs::msg::Objects, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Objects_message_members = {
  ...
  2,  // number of fields
  sizeof(object_detection_msgs::msg::Objects),
...
get_message_type_support_handle<object_detection_msgs::msg::Objects>()
{
  return &::object_detection_msgs::msg::rosidl_typesupport_introspection_cpp::Objects_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_detection_msgs, msg, Objects)() {
  return &::object_detection_msgs::msg::rosidl_typesupport_introspection_cpp::Objects_message_type_support_handle;
}
