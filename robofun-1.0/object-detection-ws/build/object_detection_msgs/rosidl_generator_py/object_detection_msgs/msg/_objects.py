    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'object_detection_msgs.msg.Objects')
            logger.debug(
...
class Objects(metaclass=Metaclass_Objects):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<object_detection_msgs/Object>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['object_detection_msgs', 'msg'], 'Object')),  # noqa: E501
    )
