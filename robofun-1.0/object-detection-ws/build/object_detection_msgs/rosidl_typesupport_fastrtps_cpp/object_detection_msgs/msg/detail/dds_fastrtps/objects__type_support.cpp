...
#include "object_detection_msgs/msg/detail/objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const object_detection_msgs::msg::Object &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const object_detection_msgs::msg::Objects & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      object_detection_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  object_detection_msgs::msg::Objects & ros_message)
{
  // Member: header
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      object_detection_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        object_detection_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        object_detection_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = object_detection_msgs::msg::Objects;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const object_detection_msgs::msg::Objects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<object_detection_msgs::msg::Objects *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_object_detection_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<object_detection_msgs::msg::Objects>()
{
  return &object_detection_msgs::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_detection_msgs, msg, Objects)() {
  return &object_detection_msgs::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
