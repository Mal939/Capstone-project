...
#include "object_detection_msgs/msg/detail/object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const object_detection_msgs::msg::Object & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  object_detection_msgs::msg::Object & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = object_detection_msgs::msg::Object;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const object_detection_msgs::msg::Object *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<object_detection_msgs::msg::Object *>(
    untyped_ros_message);
...
{
  return &object_detection_msgs::msg::typesupport_fastrtps_cpp::_Object__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_detection_msgs, msg, Object)() {
  return &object_detection_msgs::msg::typesupport_fastrtps_cpp::_Object__handle;
}
